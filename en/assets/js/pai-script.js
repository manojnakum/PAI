...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-add-reference', function() {
        ...
        var referenceRowHtml = '<div data-ReferenceNo="' + newRefId + '" class="references panel panel-default"> <div class="panel-heading clearfix"> <h4 class="panel-title" title="References">References</h4> <button type="button" class="btn-remove-reference btn-sm btn btn-default btn-outline"><i class="fi flaticon-delete"></i>Remove</button> </div><div class="panel-body"> <div class="row"> <div class="col-sm-3 col-xs-6"> <div class="form-group"> <label for="Prefix' + newRefId + '">Prefix</label> <select name="Prefix' + newRefId + '" id="Prefix' + newRefId + '" class="form-control"> <option selected disabled>Select</option> <option value="KSS">KSS</option> <option value="GSO">GSO</option> </select> </div></div><div class="col-sm-1 col-xs-6"> <div class="form-group"> <label for="Letter' + newRefId + '">Letter</label> <input type="text" id="Letter' + newRefId + '" class="form-control"> </div></div><div class="col-sm-2 col-xs-6"> <div class="form-group"> <label for="No' + newRefId + '">No</label> <input type="text" id="No' + newRefId + '" class="form-control"> </div></div><div class="col-sm-2 col-xs-6"> <div class="form-group"> <label for="Part' + newRefId + '">Part</label> <input type="text" id="Part' + newRefId + '" class="form-control"> </div></div><div class="col-sm-2 col-xs-6"> <div class="form-group"> <label for="Section' + newRefId + '">Section</label> <input type="text" id="Section' + newRefId + '" class="form-control"> </div></div><div class="col-sm-2 col-xs-6"> <div class="form-group"> <label for="Year' + newRefId + '">Year</label> <select name="Year' + newRefId + '" id="Year' + newRefId + '" class="form-control"> <option selected disabled>Select</option> <option value="2014">2014</option> <option value="2015">2015</option> <option value="2016">2016</option> <option value="2017">2017</option> </select> </div></div><div class="col-sm-12 col-xs-12"> <div class="form-group no-margin"> <textarea id="PrefixText' + newRefId + '" class="form-control" rows="3"></textarea> </div></div></div></div></div>';
